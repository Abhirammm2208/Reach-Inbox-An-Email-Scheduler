...
export default function LoginPage() {
  ...
  const handleDemoLogin = () => {
    setIsLoading(true);
    localStorage.setItem("isLoggedIn", "true");
    localStorage.setItem("userEmail", email || "demo@reachinbox.com");
    localStorage.setItem("userName", "Oliver Brown");
    setTimeout(() => {
      router.push("/dashboard");
    }, 500);
  };
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-10">
          ...
          <div className="text-center mb-8">
            ...
            <button
              ...
              className="w-full bg-[#E8F5E9] hover:bg-[#C8E6C9] text-gray-700 font-medium py-3 px-4 rounded-lg border border-[#81C784] transition-colors flex items-center justify-center gap-3 mb-4 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              {isLoading || status === "loading" ? "Connecting to Google..." : "Login with Google"}
            </button>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-[#4CAF50] hover:bg-[#45A049] text-white font-semibold py-3 px-4 rounded-lg transition-colors shadow-md"
            >
